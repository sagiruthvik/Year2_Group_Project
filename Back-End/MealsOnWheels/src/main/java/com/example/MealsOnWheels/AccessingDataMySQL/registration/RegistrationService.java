...
//                link));
    ...
    public String confirmToken(String token) {
        ...
        if(expiredAt.isBefore(LocalDateTime.now())) {
            throw new IllegalStateException("Token already expired, request a new one.");
        }

        confirmationTokenService.setConfirmedAt(token);
        userServices.enableUserAccess(confirmationToken.getUsers().getEmail());
        return "Confirmed, Email Verified.";
    }

    //Email Validation template from the internet...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Thank you for registering. Please click on the below link to activate your account: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Activate Now</a> </p></blockquote>Or"+"</p><p>"+"Click Here: "+ link +"</p><p>"+"Link will expire in 15 minutes. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
