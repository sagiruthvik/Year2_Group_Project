...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<Object> handleApiRequestException(ApiRequestException e, WebRequest webRequest) {
        ...
        ApiException apiException = new ApiException(e.getMessage(), badRequestValue, badRequest, ZonedDateTime.now(ZoneId.of("Z")), webRequest.getDescription(false));
    ...
    public ResponseEntity<Object> handleGlobalException(Exception e, WebRequest webRequest) {
        ...
        ApiException apiException = new ApiException(e.getMessage(), internalServerIssueValue, internalServerIssue, ZonedDateTime.now(ZoneId.of("Z")), webRequest.getDescription(false));
